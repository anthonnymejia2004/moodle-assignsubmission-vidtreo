...
/**
 * Event class for VIDTREO submission created.
 *
...
namespace assignsubmission_vidtreo\event;
...
class submission_created extends \core\event\base {
    ...
    public function get_description() {
        return "User {$this->userid} created a VIDTREO submission for submission {$this->objectid}.";
    }
