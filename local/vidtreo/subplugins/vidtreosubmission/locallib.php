...
/**
 * Core submission class for vidtreomodule_vidtreosubmission.
 *
 * Migrated from assignsubmission_vidtreo/locallib.php.
 * Reads global config from local_vidtreo and uses local_vidtreo AMD/template components.
 * Data is still stored in the assignsubmission_vidtreo table for backward compatibility.
 *
