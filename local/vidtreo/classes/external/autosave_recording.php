...
/**
 * Centralized external function for auto-saving video recording data.
 *
...
namespace local_vidtreo\external;
 ...
 *
 * The `contextid` parameter is the assignment ID for now but named generically
 * so this endpoint can be reused by other subplugins in the future.
 */
class autosave_recording extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            'contextid'   => new external_value(PARAM_INT, 'Context ID (assignment ID)', VALUE_REQUIRED),
     ...
     *
     * @param int    $contextid   The assignment ID.
